package com.bilibili.engine_center.tasklauncher;
...
import com.bilibili.engine_center.tasklauncher.sort.TaskSortUtil;
import com.bilibili.engine_center.tasklauncher.stat.TaskStat;
import com.bilibili.engine_center.tasklauncher.task.DispatchRunnable;
import com.bilibili.engine_center.tasklauncher.task.Task;
import com.bilibili.engine_center.tasklauncher.task.TaskCallBack;
import com.bilibili.engine_center.tasklauncher.utils.DispatcherLog;
...
public class TaskDispatcher {
    ...
    public static void init(Context context) {
        if (context != null) {
            sContext = context;
            sHasInit = true;
            sIsMainProcess = BaseUtility.isMainProcess(sContext);
        }
    }
