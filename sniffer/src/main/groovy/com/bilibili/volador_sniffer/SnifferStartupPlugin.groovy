...
class SnifferStartupPlugin implements Plugin<Project> {

    @Override
    void apply(Project project) {
        project.extensions.create("startup", SnifferStartupExtension)
        ...
        if (project.plugins.hasPlugin(AppPlugin)){
            ...
            android.registerTransform(new SnifferStartupTransform(project))
        }
    }
}
