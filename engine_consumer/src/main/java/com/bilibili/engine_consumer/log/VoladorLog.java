...
public class VoladorLog {
    private static final String TAG = "VoladorLog";
    ...
    public VoladorLog(String bufferPath, int capacity, String logPath, boolean compress) {
    ...
    static {
        System.loadLibrary("volador-lib");
    }
